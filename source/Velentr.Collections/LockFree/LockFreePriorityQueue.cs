...
namespace Velentr.Collections.LockFree
{
    ...
    public class LockFreePriorityQueue<T> : Collection, IEnumerable<T>, IEnumerable
    {
        /// <summary>
        ///     The queues
        /// </summary>
        private readonly Dictionary<QueuePriority, LockFreeQueue<T>> _queues;
        ...
        {
            this._queues = new Dictionary<QueuePriority, LockFreeQueue<T>>(Enum.GetValues(typeof(QueuePriority)).Length);
            ...
            {
                this._queues.Add((QueuePriority) values.GetValue(i), new LockFreeQueue<T>());
