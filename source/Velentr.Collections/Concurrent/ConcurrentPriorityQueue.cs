...
public class ConcurrentPriorityQueue<TElement, TPriority> : PriorityQueue<TElement, TPriority>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ConcurrentPriorityQueue{TElement, TPriority}"/> class with the specified initial capacity.
    /// </summary>
    ...
    /// </summary>
    /// <param name="comparer">The comparer used to determine the priority of elements. If null, the default comparer for <typeparamref name="TPriority"/> is used.</param>
    public ConcurrentPriorityQueue(IComparer<TPriority> comparer) : base(comparer) { }
    
    /// <summary>
    /// Initializes a new instance of the <see cref="ConcurrentPriorityQueue{TElement, TPriority}"/> class with the specified initial capacity and comparer.
    /// </summary>
    /// <param name="initialCapacity">The initial number of elements the queue can contain.</param>
    /// <param name="comparer">The comparer used to determine the priority of elements. If null, the default comparer for <typeparamref name="TPriority"/> is used.</param>
    /// <exception cref="ArgumentOutOfRangeException">Thrown when the <paramref name="initialCapacity"/> is less than 0.</exception>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ConcurrentPriorityQueue{TElement, TPriority}"/> class with the specified elements and priorities.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ConcurrentPriorityQueue{TElement, TPriority}"/> class with the specified elements, priorities, and comparer.
    /// </summary>
    /// <param name="items">The collection of element-priority pairs to add to the queue.</param>
    /// <param name="comparer">The comparer used to determine the priority of elements. If null, the default comparer for <typeparamref name="TPriority"/> is used.</param>
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="items"/> is null.</exception>
    ...
    /// </summary>
    /// <param name="element">When this method returns, contains the removed element, if the operation was successful; otherwise, the default value for the type.</param>
    /// <param name="priority">When this method returns, contains the priority of the removed element, if the operation was successful; otherwise, the default value for the type.</param>
    ...
    /// <summary>
    /// Attempts to return the element with the highest priority without removing it from the queue in a thread-safe manner.
    /// </summary>
    /// <param name="element">When this method returns, contains the element with the highest priority, if the operation was successful; otherwise, the default value for the type.</param>
    /// <param name="priority">When this method returns, contains the priority of the element, if the operation was successful; otherwise, the default value for the type.</param>
