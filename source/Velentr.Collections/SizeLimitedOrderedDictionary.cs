...
/// <summary>
///     A dictionary with a maximum size limit. When the limit is reached, it performs a specified action to handle the
///     overflow.
/// </summary>
/// <typeparam name="TKey">The type of the keys in the dictionary.</typeparam>
/// <typeparam name="TValue">The type of the values in the dictionary.</typeparam>
[DebuggerDisplay("Count = {Count}, MaxSize = {MaxSize}")]
public class SizeLimitedOrderedDictionary<TKey, TValue> : IOrderedDictionary, IDictionary<TKey, TValue>
    where TKey : notnull
{
    /// <summary>
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="SizeLimitedOrderedDictionary{TKey, TValue}" /> class with a specified
    ///     maximum size and overflow action.
    /// </summary>
    ...
    public SizeLimitedOrderedDictionary(int maxSize,
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="SizeLimitedOrderedDictionary{TKey, TValue}" /> class with a specified
    ///     capacity, maximum size, and overflow action.
    /// </summary>
    /// <param name="capacity">The initial capacity of the dictionary.</param>
    /// <param name="maxSize">The maximum size of the dictionary.</param>
    /// <param name="actionWhenFull">The action to perform when the dictionary exceeds its maximum size.</param>
    public SizeLimitedOrderedDictionary(int capacity, int maxSize,
        SizeLimitedCollectionFullAction actionWhenFull = SizeLimitedCollectionFullAction.PopOldestItem)
    {
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="SizeLimitedOrderedDictionary{TKey, TValue}" /> class from an existing
    ...
    public SizeLimitedOrderedDictionary(ImmutableSortedDictionary<TKey, TValue> dictionary, int maxSize,
        SizeLimitedCollectionFullAction actionWhenFull = SizeLimitedCollectionFullAction.PopOldestItem)
    {
        if (maxSize < 1)
        {
    ...
    public ImmutableSortedDictionary<TKey, TValue> InternalDictionary
    {
        get
        {
            SortedDictionary<TKey, TValue> output = new();
    ...
    {
        get => (TValue)this.internalDictionary[key];
    ...
    public List<TValue> ChangeMaxSize(int newMaxSize)
    {
        ...
        var remainingItemsToPop = this.internalDictionary.Count - newMaxSize;
        var currentI = 0;
        var incrementor = 0;
        ...
        {
            poppedItems.Add((TValue)this.internalDictionary[currentI]);
