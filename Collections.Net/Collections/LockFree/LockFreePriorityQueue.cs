...
namespace Collections.Net.Collections.LockFree
{
    ...
    public class LockFreePriorityQueue<T> : Collection, IEnumerable<T>, IEnumerable
    {
        ...
        /// The queues
        /// </summary>
        private Dictionary<QueuePriority, LockFreeQueue<T>> _queues;
        ...
        {
            _queues = new Dictionary<QueuePriority, LockFreeQueue<T>>(Enum.GetValues(typeof(QueuePriority)).Length);
            ...
            {
                _queues.Add((QueuePriority)values.GetValue(i), new LockFreeQueue<T>());
